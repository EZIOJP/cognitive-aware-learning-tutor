...
KIND_ALIASES: dict[str, str] = {
    ...
    "watch_list": "watch_site_block",
    "watch_site_block": "watch_site_block",
    "block_extra": "watch_site_block",
    "social": "watch_site_block",  # social treated like soft distraction speak
    "study_block": "generic_rule_break",
    "softland_block": "generic_rule_break",
    "not_listed": "generic_rule_break",
    "incubation": "generic_rule_break",
    "free_window": "generic_rule_break",  # allow path — dialogue unused
    "reward_day": "generic_rule_break",
    "allow_list": "generic_rule_break",
    "default_allow": "generic_rule_break",
    "free_mode": "generic_rule_break",
    "softland_off": "generic_rule_break",
    "unauthorized_browser": "unauthorized_browser",
