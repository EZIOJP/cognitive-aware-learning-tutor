...
| **CALT Desktop (PySide6)** | `pip install PySide6` (in `backend/requirements.txt`) | `scripts\desktop_tracker\run_calt_desktop.bat` — one process: tracker + hub `:8765` + productivity UI. Calendar stays on `/productivity`. Spec: `docs/superpowers/specs/2026-08-31-calt-desktop-pyside6-design.md` |
