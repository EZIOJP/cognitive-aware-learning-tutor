...
class AppConfig:
    ...
    thorough_parse: bool = True
    parse_speed: int = 65
    parse_chunk_lines: int = 350
    parse_pause_ms: float = 20.0
    legacy_notes_pipeline: bool = False
    ...
    def notes_path(self) -> Path:
        return notes_dir(self.notes_dir)
...
def load_config() -> AppConfig:
    ...
    cfg = AppConfig(
        ...
        use_tag_extraction=bool(data.get("use_tag_extraction", False)),
        ...
        thorough_parse=bool(data.get("thorough_parse", True)),
        parse_speed=int(data.get("parse_speed", 65)),
        parse_chunk_lines=int(data.get("parse_chunk_lines", 350)),
        parse_pause_ms=float(data.get("parse_pause_ms", 20.0)),
        legacy_notes_pipeline=bool(data.get("legacy_notes_pipeline", False)),
