...
from transcript_studio.rag_status import RagStatus, check_rag_with_opts
...
class TranscriptStudioApp(_AppBase):
    ...
    def _build_summarize_options(self, tab: ttk.Frame) -> None:
        ...
        ttk.Combobox(
            ...
            values=["fast", "balanced", "quality", "overnight"],
            width=12,
            state="readonly",
        ...
        def work() -> None:
            try:
                ...
                def done() -> None:
                    ...
                    self.status_var.set(f"Notes saved — {note_path.name}{mode_hint}")
                    if handoff_summary:
                        self._log(handoff_summary)
